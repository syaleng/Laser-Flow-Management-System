...
export interface DashboardData {
  ...
  start_date: string;
  end_date: string;
  cards: { orders: number; received_payments: string; expenses: string; profit_loss: string; customer_receivables: string; shop_payables: string; net_financial_position: string };
  ...
  recent_activity: Array<{ type: "order" | "payment" | "expense" | "loan_repayment" | "payable_repayment"; title: string; detail: string; date: string; created_at: string; user: string }>;
}
