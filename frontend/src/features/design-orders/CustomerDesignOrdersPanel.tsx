...
export function CustomerDesignOrdersPanel({ customerId, active }: { customerId: string; active: boolean }) {
  ...
  return <article className="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
