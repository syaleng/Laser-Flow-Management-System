...
export interface ReportData {
  ...
  summary: { total_orders: number; total_sales: string; received_payments: string; expenses: string; profit_loss: string; customer_receivables: string; shop_payables: string; loan_balances: string; cash_movement: string };
