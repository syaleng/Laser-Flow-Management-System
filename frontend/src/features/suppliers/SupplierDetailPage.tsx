...
export function SupplierDetailPage() {
  ...
  return <section dir="rtl" className="text-right">
    ...
    <article className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="mb-4 flex gap-2"><Button type="button" onClick={() => setType("debit")} className={type === "debit" ? "bg-red-600" : "bg-slate-500"}>مواد یا خدمت ثبتول</Button><Button type="button" onClick={() => setType("credit")} className={type === "credit" ? "bg-emerald-600" : "bg-slate-500"}>عرضه کوونکي ته ورکړه</Button></div>
